...
(3, 2, 3, 5, 'Loved every moment of it!'),
(4, 2, 4, 3, 'It was okay, not the best.'),
(5, 2, 5, 4, 'Good value for the price.'),
(6, 2, 6, 5, 'Fantastic tour with great guides!'),
(7, 2, 7, 4, 'Enjoyed it but had some issues.'),
(8, 2, 8, 5, 'Best tour I have ever been on!'),
(9, 2, 9, 4, 'Very good experience overall.'),
(10, 2, 10, 5, 'Exceeded my expectations!'),
(11, 2, 11, 4, 'Great tour but a bit pricey.'),
(12, 2, 12, 5, 'Amazing guides and beautiful locations!'),
(13, 2, 13, 4, 'Had a wonderful time on this tour.'),
(14, 2, 14, 5, 'Highly recommend this tour to everyone!'),
(15, 2, 15, 4, 'Good tour but could use some improvements.'),
(16, 2, 16, 5, 'Fantastic experience with great service!'),
(17, 2, 17, 4, 'Enjoyed the tour but had some minor issues.'),
(18, 2, 18, 5, 'Best tour I have ever taken!'),
(19, 2, 19, 4, 'Very good experience overall.'),
(20, 2, 20, 5, 'Exceeded my expectations in every way!'),
(21, 17, 21, 4, 'Great tour but a bit expensive.'),
(22, 17, 22, 5, 'Amazing guides and stunning locations!'),
(23, 17, 23, 4, 'Had a fantastic time on this tour.'),
(24, 17, 24, 5, 'Highly recommend this tour to everyone!'),
(25, 17, 25, 4, 'Good tour but could use some improvements.'),
(26, 17, 26, 5, 'Fantastic experience with great service!'),
(27, 17, 27, 4, 'Enjoyed the tour but had some minor issues.'),
