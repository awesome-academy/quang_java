...
public class CategoryController {
  ...
  @PostMapping("/create")
  public BaseResponse<CategoryDTO> createCategory(@RequestBody CategoryDTO input) {
  ...
  public BaseResponse<CategoryDTO> updateCategory(@PathVariable Long id, @RequestBody CategoryDTO input) {
